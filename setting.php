...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("UPDATE settings SET
        ...
        marquee_text = ?
        WHERE id = 1");
    $stmt->execute([$nama_lembaga, $lat, $lng, $radius, $jam_masuk, $jam_pulang, $jam_maksimal, $hari_libur, $marquee_text]);
    ...
    <div class="card shadow">
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label class="form-label fw-bold">Teks Marquee / Pengumuman</label>
                    <textarea name="marquee_text" class="form-control" rows="3"><?= htmlspecialchars($settings['marquee_text'] ?? 'Selamat datang di Smart Electronic Attendance Network (SEAN V.01) SMANSAPAL. Jangan lupa absen datang dan pulang dengan tepat waktu.') ?></textarea>
                </div>
                <hr>
