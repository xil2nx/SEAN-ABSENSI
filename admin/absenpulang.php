...
$stmt = $pdo->prepare("SELECT s.nis, s.nama_siswa, k.nama_kelas, a.jam_datang 
                       ...
                       WHERE a.tanggal = ? AND a.jam_datang IS NOT NULL AND a.jam_pulang IS NULL 
...
<head>
    ...
    <title>Laporan Belum Absen Pulang</title>
...
<body class="bg-light p-3">
    <h3>Siswa Belum Absen Pulang Hari Ini (<?= date('d M Y') ?>)</h3>
    <a href="dashboard.php" class="btn btn-secondary mb-3">← Kembali</a>
    <div class="card">
        <div class="card-body">
            <?php if (empty($data)): ?>
                <div class="alert alert-success text-center">Semua siswa sudah absen pulang hari ini.</div>
            <?php else: ?>
