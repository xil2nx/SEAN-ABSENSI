...
$stmt = $pdo->prepare("SELECT s.nis, s.nama_siswa, k.nama_kelas, a.jam_datang 
                       ...
                       WHERE a.tanggal = ? AND a.status = 'Terlambat' 
...
<head>
    ...
    <title>Laporan Terlambat Hari Ini</title>
...
<body class="bg-light p-3">
    <h3>Siswa Terlambat Hari Ini (<?= date('d M Y') ?>)</h3>
    <a href="dashboard.php" class="btn btn-secondary mb-3">← Kembali</a>
    <div class="card">
        <div class="card-body">
            <?php if (empty($data)): ?>
                <div class="alert alert-info text-center">Tidak ada siswa terlambat hari ini.</div>
            <?php else: ?>
